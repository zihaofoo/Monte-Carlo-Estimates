...
%% Initialization
    ...
    Y1 = normrnd(mu_Y, sigma_Y, 1) * ones(num_x / 4, 1);
    Y2 = normrnd(mu_Y, sigma_Y, 1) * ones(num_x / 4, 1);
    Y3 = normrnd(mu_Y, sigma_Y, 1) * ones(num_x / 4, 1);
    Y4 = normrnd(mu_Y, sigma_Y, 1) * ones(num_x / 4, 1);
